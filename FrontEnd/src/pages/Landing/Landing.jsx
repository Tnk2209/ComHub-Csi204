    ...
    <div className="flex flex-col font-sans bg-app-bg text-app-text transition-colors">
      ...
      <main className="flex-grow flex flex-col justify-center items-center px-4 py-16 text-center max-w-4xl mx-auto">
        <div className="mb-6 flex justify-center">
          <img src={logo} alt="ComHub Logo" className="h-32 sm:h-40 w-auto object-contain drop-shadow-md animate-fade-in" />
        </div>

        <h1 className="sm:w-7xl text-4xl sm:text-6xl font-bold tracking-tight text-app-text mb-6 leading-tight">
          {t('landing.title_main')} <br />
          <span className="text-blue">{t('landing.title_highlight')}</span>
        </h1>

        <p className="sm:w-8xl text-lg text-app-text-muted mb-10 max-w-4xl leading-relaxed">
          {t('landing.subtitle')}
        </p>
