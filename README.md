...
> **แพลตฟอร์มอีคอมเมิร์ซสำหรับจัดสเปคและจำหน่ายอุปกรณ์คอมพิวเตอร์ครบวงจร**
> (BuildIT: Comprehensive E-Commerce Platform for Custom PC Building and IT Accessories)
...
├── architecture.mermaid     # ไฟล์เก็บโค้ดจำลองโครงสร้างระบบ (Mermaid Diagram Code)
├── index.html               # หน้าหลักสำหรับเปิดใช้งานระบบแสดงผลเอกสารผ่าน GitHub Pages
└── markdown.html            # หน้าแสดงเอกสารจำลองระบบจัดสเปคแบบ Interactive (สำหรับทดสอบในพื้นที่)
```

---

## 🚀 เครื่องมือและเทคโนโลยีหลัก (Technologies)
*   **Frontend:** React + Vite, Tailwind CSS (สำหรับแอปพลิเคชันจริงในเฟสถัดไป)
*   **Backend:** Node.js + Express (TypeScript)
*   **Database Simulation:** LocalStorage และ JSON Object
*   **Documentation Tools:** Markdown, HTML5, `marked.js` (Markdown Parser), `mermaid.js` (Diagram Drawing)

---

## 🧑‍💻 สมาชิกทีมผู้พัฒนา
*   `นายธนกร สิงห์ก้อม รหัสนักศึกษา 65007905`
*   `นายหาญณรงค์ บุญยืน รหัสนักศึกษา 65057638`
