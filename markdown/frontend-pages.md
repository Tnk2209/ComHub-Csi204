# สรุปโครงร่างหน้าระบบและหน้าจอฝั่งหน้าบ้าน (Frontend Page List & Specifications)

เอกสารนี้รวบรวมรายละเอียดโครงสร้างหน้าจอแสดงผลหน้าบ้าน (Frontend Pages) ของระบบ **ComHub** แยกตามบทบาทของผู้ใช้งานทั้ง 4 บทบาท (Actors) เพื่อใช้เป็นคู่มืออ้างอิงในการออกแบบส่วนติดต่อผู้ใช้งาน (UI/UX Mockups) และเขียนโค้ดหน้าบ้าน
...
### 1.5 หน้าประวัติสั่งซื้อและติดตามสถานะประกอบ (Order Tracking & UAT Page)
...
### 1.6 หน้ารวมของโปรดและการตั้งเตือนของเติมสต็อก (Wishlist & Alerts Page)
...
### 1.7 หน้าแกลเลอรี่คอมมูนิตี้ (PC Build Gallery Board)
...
## 🔧 2. บทบาท: พนักงานจัดประกอบเครื่อง (Staff Pages)

ช่างประกอบคอมพิวเตอร์ผู้ตรวจสอบคุณภาพและอัปเดตสเตตัสการขนส่ง

### 2.1 หน้าจอคิวงานจัดประกอบคอมพิวเตอร์ (Staff Assembly Queue Page)
...
### 2.2 หน้าฟอร์มบันทึกคุณภาพ UAT และเลขนำส่งพัสดุ (UAT & Shipping Logs Form)
...
## 📈 3. บทบาท: ผู้จัดการร้าน (Manager Pages)

ผู้อนุมัติสื่อความเหมาะสมระบบคอมมูนิตี้และสร้างโปรโมชั่นแนะนำ

### 3.1 หน้าสรุปสถิติวิเคราะห์ระบบภาพรวม (Manager Business Dashboard)
...
### 3.2 หน้าต่างควบคุมและสร้างสเปคคอมแนะนำของร้าน (Pre-built Templates CRUD Panel)
...
### 3.3 หน้าต่างคัดกรองรูปถ่ายรีวิวและแกลเลอรี่คอมมูนิตี้ (Moderation Board)
...
## 🔑 4. บทบาท: ผู้ดูแลระบบ (Admin Pages)

ผู้ควบคุมสต็อกสินค้าและระบบกระจายสิทธิ์ยูสเซอร์หลังบ้าน

### 4.1 หน้าต่างจัดการแค็ตตาล็อกและปิดตัวสินค้าไอที (Admin Products CRUD Panel)
...
### 4.2 หน้าต่างจัดการสิทธิ์ผู้ใช้งาน (Accounts Controls Panel)
...
### 4.3 หน้าต่างอนุมัติยอดโอนเงินและการโรลแบ็กสินค้า (Payment Review & Stock Controller)
...
*   **องค์ประกอบหลักบน UI:**
    ...
    *   ปุ่มกดสั่งยกเลิกสลิปการเงินปลอม (`Rejected`) ซึ่งระบบจะทำสต็อกโรลแบ็ก (Stock Rollback) คืนสินค้าคงคลังบวกกลับให้ในร้านโดยอัตโนมัติ
